...
const PRICING_TIERS = [
  {
    ...
    price: "$5k - $10k",
    mrr: "$2,000 / mo",
    description: "Perfect for establishing your baseline AI follow-up and plugging the most obvious leaky buckets in your sales process.",
    features: [
      "Instant Lead Follow-ups (Under 60s)",
      "Basic CRM & Scheduling Integration",
  ...
  },
  {
    ...
    price: "$10k - $20k",
    mrr: "$1,000 / mo",
    description: "Scale your operations with advanced conversational logic and member retention systems to maximize lifetime value.",
    features: [
      "Everything in Starter",
      "Predictive Churn AI & Alerts",
  ...
  },
  {
    ...
    price: "$20k - $30k",
    mrr: "$1,000 - $1,500 / mo",
    description: "The ultimate ecosystem. Completely automate your sales, marketing, and retention so you can focus purely on the gym.",
    features: [
      "Everything in Advanced",
      "Custom AI Voice Agents",
      "End-to-End Workflow Automation",
      "Dedicated AI Strategist & Audits",
    ],
    highlight: false,
  },
];
